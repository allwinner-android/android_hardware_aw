...
//that(The number) is different from H264-bitstream and MJPEG-bitstream..
    ...
    if (mTakePictureState == TAKE_PICTURE_NORMAL)
    {
	 ...
	 LOGE("zjw,mTakePictureState == TAKE_PICTURE_NORMAL nShareBufFd = %d",nShareBufFd);
        ...
        LOGE("zjw,mTakePictureState == TAKE_PICTURE_NORMAL mPicBuffer.nShareBufFd = %d",mPicBuffer.nShareBufFd);
